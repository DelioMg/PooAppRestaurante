    ...
    public BigDecimal calcularSalario() {
     ...
     return new BigDecimal(soma);
      ...
      public String toString(){
       String user;
       user = "Dados da Entregador "+this.nome+ " email: "+this.email+ " senha: "+this.senha+ " Placa da moto: "+this.placa+" telefone:"+this.telefone+" Salario: "+this.calcularSalario()+" Grupo "+this.grupo;
      return user;
    }
}
